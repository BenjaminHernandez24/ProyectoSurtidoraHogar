...
class VentasModelo
{
    ...
    private static $INSERTAR_DETALLE_SALIDA_VENTA = "INSERT INTO detalle_salida_venta(cliente,metodo_pago,total,pago,cambio,fecha,hora) values(?,?,?,?,?,(SELECT CURRENT_DATE),(SELECT CURRENT_TIME))";
    ...
    public static function AgregarDetalleSalidaVenta($venta)
    {
        try {
            ...
            $resultado = $pst->execute([$venta['cliente'], $venta['pago'], $venta['total'], $venta['cobro'], $venta['cambio']]);
