...
class NotificacionModel{
 private static $vacios = "SELECT p.nombre_producto as nombre, i.stock as stock FROM inventario i INNER JOIN productos p ON i.stock <= i.estatus_alerta AND p.id_producto=i.id_producto ORDER BY i.id_inventario";
